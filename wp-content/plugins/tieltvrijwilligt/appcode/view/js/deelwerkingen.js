   jQuery(document).ready(function () {
    		...
    		var tabel = jQuery("#deelwerkingenTabel");
            ...
            jQuery("table").on("click", "button.btndelete", deleteDeelwerking);
            
            //6.export to excel
            jQuery("#btnexcel").click(function(){
            alert('hi');
            jQuery("#deelwerkingenTabel").table2excel({
        	// exclude CSS class
        	exclude: ".noExl",
        	name: "Deelwerkingen",
        	filename: "deelwerkingen", 
        	fileext: ".xls"
            });
     		});
            ...
            */
            ...
            function deleteDeelwerking() {
                ...
                */
                ...
                var r = confirm("Bent u zeker om deze deelwerking te verwijderen?");
                if(r == true)
                {
                    window.location.href = 'http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/deelwerking.control.php?deelwerkingid=' + id;
                    return false; //to prevent window.location.href is assigned badly;
                }
                             
                                
            } //end deleteDeelwerking
